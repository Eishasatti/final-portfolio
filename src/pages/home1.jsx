...
const Home1 = () => {
  return (
    <div className="container-fluid text-dark-blue bg-yellow-100 font-poppins">
      {/* Navbar */}
      <div className="d-flex justify-content-center align-items-center py-3 px-4 bg-yellow-200 shadow-sm">
      ...
      <div className="row my-5">
        ...
        <div className="col-lg-6 col-md-12">
          <h2 className="display-3 font-semibold text-primary">About</h2>
        ...
        {/* Work Section */}
        <div className="col-lg-6 col-md-12">
          <h2 className="display-3 font-semibold text-primary">Work</h2>
          <p className="lead font-normal">
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 col-md-6">
              <h2 className="display-4 font-semibold text-warning">Contact</h2>
              <p className="lead">
            ...
            <div className="col-md-6">
              <h2 className="display-4 font-semibold text-warning">Follow me</h2>
